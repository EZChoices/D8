...
export default function DirectSupply() {
  return (
    <section className="section">
      ...
      <ul>
        <li>Sourcing: contracts with known growers and extractors under quality agreements.</li>
        <li>Extraction & refinement: clean solvent processes; verified inputs and outputs by lot.</li>
        <li>Formulation & filling: controlled environments; calibrated equipment; in‑process checks.</li>
        <li>Batching & labeling: unique batch IDs tied to COAs and production dates.</li>
        <li>Final QC & release: review of potency, contaminants, labeling, and packaging integrity.</li>
      </ul>

      <h2>Standards & Documentation</h2>
      <ul>
        <li>Manufacturing practices aligned to GMP principles; SOPs and training records maintained by partners.</li>
        <li>Third‑party labs with ISO/IEC 17025 accreditation perform potency and contaminant testing.</li>
        <li>Documentation available on request (use‑case dependent): COA, SDS/MSDS, allergen statements, and COI.</li>
